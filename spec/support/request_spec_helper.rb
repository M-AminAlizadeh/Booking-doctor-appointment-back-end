module RequestSpecHelper
  ...
  def confirm_and_login_user(user_role = 'admin')
    ...
    doctor = Doctor.create(name: 'Dr. John Doe', hospital: 'New York',
                           specialization: 'Cardiology', cost_per_consult: 100, description: 'Dr. John Doe is a cardio')
    Reservation.create(date_of_appointment: '2000-09-07', doctor_id: doctor.id, user_id: user.id)
  ...
  def login_and_create_appointment()
    ...
    doctor = Doctor.create(name: 'Dr. John Doe', hospital: 'New York',
                           specialization: 'Cardiology', cost_per_consult: 100, description: 'Dr. John Doe is a cardio')
    appointment = Reservation.create(date_of_appointment: '2000-09-07', doctor_id: doctor.id, user_id: user.id)
