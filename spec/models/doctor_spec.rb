...
RSpec.describe Doctor, type: :model do
  ...
  it 'cost per day should be integer' do
    subject.cost_per_consult = 'text'
    expect(subject).to_not be_valid
  end

  it 'cost per day should not be negative' do
    subject.cost_per_consult = -5
    expect(subject).to_not be_valid
  end
